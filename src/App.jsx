...
const TARGETS = [
  { system:"Proxima Centauri", planet:"Proxima Cen b",  distance_pc:1.2948,  color:"#fff176", type:"Rocky",        hz:true,  disc_year:2016, notes:"Nearest known exoplanet. Rocky world in the habitable zone of a red dwarf — 4.2 ly away." , orbital_period_days:11.19, tidally_locked:true , v_r:-22.2 },
  { system:"Proxima Centauri", planet:"Proxima Cen d",  distance_pc:1.2948,  color:"#ffe082", type:"Rocky",        hz:false, disc_year:2022, notes:"Sub-Earth mass planet orbiting very close to Proxima Centauri. Too hot for liquid water." , orbital_period_days:5.12, tidally_locked:true , v_r:-22.2 },
  { system:"Barnard's Star",   planet:"Barnard b",      distance_pc:1.8282,  color:"#ef9a9a", type:"Super-Earth",  hz:false, disc_year:2024, notes:"Candidate super-Earth around the second-nearest star system to the Sun." , orbital_period_days:3.15, tidally_locked:true , v_r:-110.6 },
  { system:"Wolf 359",         planet:"Wolf 359 b",     distance_pc:2.3900,  color:"#f48fb1", type:"Gas Giant",    hz:false, disc_year:2019, notes:"Gas giant orbiting one of the nearest stars — famous from Star Trek." , orbital_period_days:2617.0, tidally_locked:false , v_r:19.3 },
  { system:"Lalande 21185",    planet:"Lalande 21185 b",distance_pc:2.5457,  color:"#ce93d8", type:"Super-Earth",  hz:true,  disc_year:2017, notes:"Super-Earth candidate in the habitable zone of a nearby M-dwarf." , orbital_period_days:12.94, tidally_locked:true , v_r:-84.7 },
  // ── NEARBY SYSTEMS ───────────────────────────────────────────────────────
  { system:"GJ 667C",          planet:"GJ 667C c",      distance_pc:6.8432,  color:"#80cbc4", type:"Super-Earth",  hz:true,  disc_year:2011, notes:"Super-Earth firmly in the habitable zone. One of the best nearby HZ candidates." , orbital_period_days:28.14, tidally_locked:true , v_r:6.5 },
  { system:"GJ 667C",          planet:"GJ 667C e",      distance_pc:6.8432,  color:"#4db6ac", type:"Super-Earth",  hz:true,  disc_year:2013, notes:"Second habitable zone planet in the GJ 667C system." , orbital_period_days:62.24, tidally_locked:true , v_r:6.5 },
  { system:"GJ 581",           planet:"GJ 581 c",       distance_pc:6.2981,  color:"#f06292", type:"Super-Earth",  hz:false, disc_year:2007, notes:"Super-Earth near the inner edge of the habitable zone. Dense and likely rocky." , orbital_period_days:12.92, tidally_locked:true , v_r:-9.4 },
  { system:"GJ 581",           planet:"GJ 581 d",       distance_pc:6.2981,  color:"#e91e8c", type:"Super-Earth",  hz:true,  disc_year:2007, notes:"Outer super-Earth — possibly habitable with a thick CO₂ atmosphere." , orbital_period_days:66.87, tidally_locked:true , v_r:-9.4 },
  { system:"Epsilon Eridani",  planet:"Epsilon Eri b",  distance_pc:3.2127,  color:"#ffab91", type:"Gas Giant",    hz:false, disc_year:2000, notes:"Jupiter-like planet around one of the Sun's nearest stellar neighbors." , orbital_period_days:2502.0, tidally_locked:false , v_r:-16.4 },
  { system:"Tau Ceti",         planet:"Tau Ceti e",     distance_pc:3.6481,  color:"#ffe0b2", type:"Super-Earth",  hz:true,  disc_year:2012, notes:"Super-Earth in the habitable zone of a Sun-like star — 12 ly away." , orbital_period_days:168.12, tidally_locked:false , v_r:-16.9 },
  { system:"Tau Ceti",         planet:"Tau Ceti f",     distance_pc:3.6481,  color:"#ffcc80", type:"Super-Earth",  hz:true,  disc_year:2012, notes:"Outer habitable zone candidate around Tau Ceti." , orbital_period_days:642.0, tidally_locked:false , v_r:-16.9 },
  // ── TRAPPIST SYSTEM ──────────────────────────────────────────────────────
  { system:"TRAPPIST-1",       planet:"TRAPPIST-1 b",   distance_pc:12.4299, color:"#b3e5fc", type:"Rocky",        hz:false, disc_year:2017, notes:"Innermost TRAPPIST-1 planet. Too hot — likely a Venus analog." , orbital_period_days:1.511, tidally_locked:true , v_r:-56.3 },
  { system:"TRAPPIST-1",       planet:"TRAPPIST-1 c",   distance_pc:12.4299, color:"#81d4fa", type:"Rocky",        hz:false, disc_year:2017, notes:"Rocky world — recent JWST data suggests little to no atmosphere." , orbital_period_days:2.422, tidally_locked:true , v_r:-56.3 },
  { system:"TRAPPIST-1",       planet:"TRAPPIST-1 d",   distance_pc:12.4299, color:"#4fc3f7", type:"Rocky",        hz:true,  disc_year:2017, notes:"Inner habitable zone. Receives similar energy to Earth from the Sun." , orbital_period_days:4.05, tidally_locked:true , v_r:-56.3 },
  { system:"TRAPPIST-1",       planet:"TRAPPIST-1 e",   distance_pc:12.4299, color:"#29b6f6", type:"Rocky",        hz:true,  disc_year:2017, notes:"Best habitable zone rocky planet known. Earth-sized, top priority for biosignature searches." , orbital_period_days:6.101, tidally_locked:true , v_r:-56.3 },
  { system:"TRAPPIST-1",       planet:"TRAPPIST-1 f",   distance_pc:12.4299, color:"#039be5", type:"Rocky",        hz:true,  disc_year:2017, notes:"Outer habitable zone. Possibly a water-rich world or ice-covered surface." , orbital_period_days:9.207, tidally_locked:true , v_r:-56.3 },
  { system:"TRAPPIST-1",       planet:"TRAPPIST-1 g",   distance_pc:12.4299, color:"#0288d1", type:"Rocky",        hz:true,  disc_year:2017, notes:"Outer habitable zone. Larger than Earth — may have a thick H₂O envelope." , orbital_period_days:12.353, tidally_locked:true , v_r:-56.3 },
  { system:"TRAPPIST-1",       planet:"TRAPPIST-1 h",   distance_pc:12.4299, color:"#0277bd", type:"Rocky",        hz:false, disc_year:2017, notes:"Outermost TRAPPIST-1 planet. Likely frozen — too cold for liquid water." , orbital_period_days:18.767, tidally_locked:true , v_r:-56.3 },
  // ── WATER WORLDS & SUB-NEPTUNES ──────────────────────────────────────────
  { system:"GJ 1214",          planet:"GJ 1214 b",      distance_pc:14.6427, color:"#80deea", type:"Water World",  hz:false, disc_year:2009, notes:"The archetypal water world. Flat transmission spectrum suggests thick steam or water atmosphere." , orbital_period_days:1.58, tidally_locked:true , v_r:21.0 },
  { system:"GJ 3470",          planet:"GJ 3470 b",      distance_pc:29.3500, color:"#4dd0e1", type:"Sub-Neptune",  hz:false, disc_year:2012, notes:"Warm Neptune-like world with a large extended atmosphere being actively evaporated." , orbital_period_days:3.337, tidally_locked:true , v_r:26.3 },
  { system:"GJ 436",           planet:"GJ 436 b",       distance_pc:9.7556,  color:"#26c6da", type:"Neptune-like", hz:false, disc_year:2004, notes:"Hot Neptune orbiting very close. Has a giant comet-like tail of escaping hydrogen." , orbital_period_days:2.644, tidally_locked:true , v_r:9.6 },
  { system:"55 Cancri",        planet:"55 Cnc e",       distance_pc:12.590,  color:"#ffab91", type:"Super-Earth",  hz:false, disc_year:2004, notes:"Ultra-hot super-Earth — surface possibly covered in molten lava. Year = 18 hours." , orbital_period_days:0.737, tidally_locked:true , v_r:27.6 },
  { system:"55 Cancri",        planet:"55 Cnc f",       distance_pc:12.590,  color:"#ff8a65", type:"Gas Giant",    hz:true,  disc_year:2005, notes:"Gas giant in the outer habitable zone of 55 Cancri — any moons could be habitable." , orbital_period_days:259.0, tidally_locked:false , v_r:27.6 },
  { system:"LHS 1140",         planet:"LHS 1140 b",     distance_pc:14.9861, color:"#ef9a9a", type:"Super-Earth",  hz:true,  disc_year:2017, notes:"Rocky super-Earth in the habitable zone — one of the best targets for atmospheric study." , orbital_period_days:24.737, tidally_locked:true , v_r:26.5 },
  { system:"LHS 1140",         planet:"LHS 1140 c",     distance_pc:14.9861, color:"#e57373", type:"Rocky",        hz:false, disc_year:2020, notes:"Inner rocky planet in the LHS 1140 system — too hot for liquid water." , orbital_period_days:3.778, tidally_locked:true , v_r:26.5 },
  // ── TOI SYSTEMS ──────────────────────────────────────────────────────────
  { system:"TOI-1231",         planet:"TOI-1231 b",     distance_pc:27.6227, color:"#ce93d8", type:"Sub-Neptune",  hz:false, disc_year:2021, notes:"Warm sub-Neptune with a cool enough temperature to possibly retain a thick atmosphere." , orbital_period_days:24.246, tidally_locked:true , v_r:13.4 },
  { system:"TOI-700",          planet:"TOI-700 d",      distance_pc:31.1400, color:"#a5d6a7", type:"Rocky",        hz:true,  disc_year:2020, notes:"Earth-sized planet in the habitable zone — one of the first confirmed HZ rocky planets from TESS." , orbital_period_days:37.422, tidally_locked:true , v_r:13.8 },
  { system:"TOI-700",          planet:"TOI-700 e",      distance_pc:31.1400, color:"#81c784", type:"Rocky",        hz:true,  disc_year:2023, notes:"Second habitable zone planet in the TOI-700 system — slightly smaller than Earth." , orbital_period_days:27.81, tidally_locked:true , v_r:13.8 },
  { system:"TOI-1452",         planet:"TOI-1452 b",     distance_pc:99.3000, color:"#80deea", type:"Water World",  hz:true,  disc_year:2022, notes:"Water world candidate — density suggests up to 30% water by mass. In the habitable zone." , orbital_period_days:11.063, tidally_locked:true , v_r:-16.2 },
  { system:"TOI-2285",         planet:"TOI-2285 b",     distance_pc:52.0000, color:"#4fc3f7", type:"Sub-Neptune",  hz:true,  disc_year:2022, notes:"Sub-Neptune near the habitable zone of a nearby M-dwarf star." , orbital_period_days:27.268, tidally_locked:true , v_r:8.4 },
  { system:"TOI-4633",         planet:"TOI-4633 c",     distance_pc:110.000, color:"#fff59d", type:"Rocky",        hz:true,  disc_year:2023, notes:"Rocky planet in the habitable zone of a Sun-like star in a binary system." , orbital_period_days:272.0, tidally_locked:false , v_r:-12.1 },
  // ── KEPLER SYSTEMS ───────────────────────────────────────────────────────
  { system:"Kepler-22",        planet:"Kepler-22 b",    distance_pc:194.642, color:"#c5e1a5", type:"Sub-Neptune",  hz:true,  disc_year:2011, notes:"First confirmed planet in the habitable zone of a Sun-like star. 2.4× Earth radius." , orbital_period_days:289.862, tidally_locked:false , v_r:-39.3 },
  { system:"Kepler-62",        planet:"Kepler-62 e",    distance_pc:368.000, color:"#a5d6a7", type:"Super-Earth",  hz:true,  disc_year:2013, notes:"Super-Earth in the habitable zone — possibly a water world with a global ocean." , orbital_period_days:122.387, tidally_locked:false , v_r:-46.2 },
  { system:"Kepler-62",        planet:"Kepler-62 f",    distance_pc:368.000, color:"#66bb6a", type:"Super-Earth",  hz:true,  disc_year:2013, notes:"Outer habitable zone super-Earth. One of the earliest compelling HZ candidates." , orbital_period_days:267.291, tidally_locked:false , v_r:-46.2 },
  { system:"Kepler-186",       planet:"Kepler-186 f",   distance_pc:178.500, color:"#aed581", type:"Rocky",        hz:true,  disc_year:2014, notes:"First Earth-sized planet confirmed in the habitable zone of another star." , orbital_period_days:129.944, tidally_locked:false , v_r:22.4 },
  { system:"Kepler-296",       planet:"Kepler-296 e",   distance_pc:740.000, color:"#dce775", type:"Super-Earth",  hz:true,  disc_year:2014, notes:"Habitable zone super-Earth around an M-dwarf binary system." , orbital_period_days:34.141, tidally_locked:true , v_r:15.6 },
  { system:"Kepler-438",       planet:"Kepler-438 b",   distance_pc:472.900, color:"#fff176", type:"Rocky",        hz:true,  disc_year:2015, notes:"One of the most Earth-like planets known by ESI score — but bombarded by stellar flares." , orbital_period_days:35.233, tidally_locked:true , v_r:-36.8 },
  { system:"Kepler-442",       planet:"Kepler-442 b",   distance_pc:342.000, color:"#ffee58", type:"Super-Earth",  hz:true,  disc_year:2015, notes:"One of the best HZ candidates — receives ~70% of Earth's solar flux from a cooler star." , orbital_period_days:112.305, tidally_locked:false , v_r:-40.1 },
  { system:"Kepler-452",       planet:"Kepler-452 b",   distance_pc:551.727, color:"#ffcc80", type:"Super-Earth",  hz:true,  disc_year:2015, notes:"⚠ Controversial — possibly Earth's older cousin at 1.5× radius, or a false positive." , orbital_period_days:384.843, tidally_locked:false , v_r:-35.2 },
  { system:"Kepler-1649",      planet:"Kepler-1649 c",  distance_pc:290.900, color:"#ff8a65", type:"Rocky",        hz:true,  disc_year:2020, notes:"Earth-sized HZ planet around an M-dwarf — among the most Earth-like found by Kepler." , orbital_period_days:19.535, tidally_locked:true , v_r:18.3 },
  { system:"Kepler-69",        planet:"Kepler-69 c",    distance_pc:730.000, color:"#bcaaa4", type:"Super-Earth",  hz:false, disc_year:2013, notes:"Super-Earth near the inner edge of the HZ — possibly a super-Venus." , orbital_period_days:242.461, tidally_locked:false , v_r:-25.7 },
  // ── HOT JUPITERS ─────────────────────────────────────────────────────────
  { system:"51 Pegasi",        planet:"51 Peg b",       distance_pc:15.3600, color:"#ffb74d", type:"Hot Jupiter",  hz:false, disc_year:1995, notes:"The first exoplanet found around a Sun-like star. Nobel Prize 2019. Year = 4.2 days." , orbital_period_days:4.231, tidally_locked:true , v_r:-33.0 },
  { system:"HD 209458",        planet:"HD 209458 b",    distance_pc:47.0000, color:"#ffa726", type:"Hot Jupiter",  hz:false, disc_year:1999, notes:"'Osiris' — first exoplanet observed transiting its star. Has an evaporating atmosphere." , orbital_period_days:3.525, tidally_locked:true , v_r:-14.7 },
  { system:"HD 189733",        planet:"HD 189733 b",    distance_pc:19.7600, color:"#4fc3f7", type:"Hot Jupiter",  hz:false, disc_year:2005, notes:"Deep-blue hot Jupiter where it rains molten glass sideways at 9,000 km/h winds." , orbital_period_days:2.219, tidally_locked:true , v_r:-2.3 },
  { system:"WASP-17",          planet:"WASP-17 b",      distance_pc:390.000, color:"#b0bec5", type:"Hot Jupiter",  hz:false, disc_year:2009, notes:"One of the largest exoplanets known — puffed up, retrograde orbit, extremely low density." , orbital_period_days:3.735, tidally_locked:true , v_r:60.4 },
  { system:"WASP-121",         planet:"WASP-121 b",     distance_pc:270.000, color:"#ffcc02", type:"Ultra-hot Jupiter", hz:false, disc_year:2015, notes:"Ultra-hot Jupiter where iron and titanium rain from the atmosphere. Temperature ~2,400 K." , orbital_period_days:1.275, tidally_locked:true , v_r:38.2 },
  { system:"KELT-9",           planet:"KELT-9 b",       distance_pc:294.000, color:"#ff5722", type:"Ultra-hot Jupiter", hz:false, disc_year:2016, notes:"Hottest known exoplanet — hotter than most stars at ~4,300 K. Atmosphere is vaporizing." , orbital_period_days:1.481, tidally_locked:true , v_r:-20.6 },
  { system:"HAT-P-7",          planet:"HAT-P-7 b",      distance_pc:320.000, color:"#ff7043", type:"Hot Jupiter",  hz:false, disc_year:2008, notes:"Hot Jupiter where corundum (sapphire/ruby) clouds rain from the sky on the night side." , orbital_period_days:2.205, tidally_locked:true , v_r:-12.8 },
  // ── GAS GIANTS & DIRECT IMAGING ──────────────────────────────────────────
  { system:"HR 8799",          planet:"HR 8799 b",      distance_pc:39.4000, color:"#ce93d8", type:"Gas Giant",    hz:false, disc_year:2008, notes:"First multi-planet system discovered by direct imaging. Young super-Jupiter." , orbital_period_days:164250.0, tidally_locked:false , v_r:12.0 },
  { system:"HR 8799",          planet:"HR 8799 e",      distance_pc:39.4000, color:"#ba68c8", type:"Gas Giant",    hz:false, disc_year:2010, notes:"Innermost directly imaged planet in HR 8799 — hints of water and CO in its atmosphere." , orbital_period_days:18000.0, tidally_locked:false , v_r:12.0 },
  { system:"Beta Pictoris",    planet:"Beta Pic b",     distance_pc:19.4400, color:"#ef9a9a", type:"Gas Giant",    hz:false, disc_year:2008, notes:"Young gas giant caught in the act of forming — directly imaged orbiting a debris disk." , orbital_period_days:8030.0, tidally_locked:false , v_r:20.0 },
  { system:"Beta Pictoris",    planet:"Beta Pic c",     distance_pc:19.4400, color:"#e57373", type:"Gas Giant",    hz:false, disc_year:2019, notes:"Second directly imaged planet — causes gaps in Beta Pic's dusty debris disk." , orbital_period_days:1200.0, tidally_locked:false , v_r:20.0 },
  { system:"Fomalhaut",        planet:"Fomalhaut b",    distance_pc:7.6900,  color:"#80cbc4", type:"Gas Giant",    hz:false, disc_year:2008, notes:"Directly imaged — may be a cloud of debris from a recent collision rather than a solid planet." , orbital_period_days:323652.0, tidally_locked:false , v_r:6.5 },
  // ── INTERESTING & EXOTIC ─────────────────────────────────────────────────
  { system:"55 Cancri",        planet:"55 Cnc d",       distance_pc:12.590,  color:"#a5d6a7", type:"Gas Giant",    hz:false, disc_year:2002, notes:"Long-period Jupiter analog in the 55 Cancri system — 14-year orbit." , orbital_period_days:4825.0, tidally_locked:false , v_r:27.6 },
  { system:"Upsilon Andromedae",planet:"Ups And d",     distance_pc:13.4700, color:"#ffb74d", type:"Gas Giant",    hz:false, disc_year:1999, notes:"Outer gas giant in a multi-planet system around a bright nearby star." , orbital_period_days:1276.46, tidally_locked:false , v_r:-28.9 },
  { system:"Gliese 876",       planet:"Gliese 876 d",   distance_pc:4.6900,  color:"#ef9a9a", type:"Rocky",        hz:false, disc_year:2005, notes:"One of the first confirmed super-Earths. Very hot — year = 1.94 days." , orbital_period_days:1.938, tidally_locked:true , v_r:-1.5 },
  { system:"Gliese 876",       planet:"Gliese 876 b",   distance_pc:4.6900,  color:"#ff8a65", type:"Gas Giant",    hz:false, disc_year:1998, notes:"Jupiter-mass planet in a 2:1 resonance with Gliese 876 c. 60 ly away." , orbital_period_days:60.94, tidally_locked:false , v_r:-1.5 },
  { system:"K2-18",            planet:"K2-18 b",        distance_pc:38.0000, color:"#80deea", type:"Water World",  hz:true,  disc_year:2015, notes:"Possible Hycean world — JWST detected carbon molecules. May have a liquid water ocean under a H₂ atmosphere." , orbital_period_days:32.94, tidally_locked:true , v_r:2.6 },
  { system:"GJ 3512",          planet:"GJ 3512 b",      distance_pc:9.4900,  color:"#ffab91", type:"Gas Giant",    hz:false, disc_year:2019, notes:"Jupiter-mass planet around a tiny M-dwarf — challenges planet formation theories." , orbital_period_days:203.59, tidally_locked:false , v_r:-23.4 },
  { system:"L 98-59",          planet:"L 98-59 b",      distance_pc:10.6200, color:"#b0bec5", type:"Rocky",        hz:false, disc_year:2019, notes:"Sub-Earth mass planet — one of the lightest exoplanets known. Year = 2.25 days." , orbital_period_days:2.253, tidally_locked:true , v_r:5.4 },
  { system:"L 98-59",          planet:"L 98-59 d",      distance_pc:10.6200, color:"#90a4ae", type:"Rocky",        hz:false, disc_year:2019, notes:"Third planet in L 98-59 — may retain water. Top JWST atmospheric target." , orbital_period_days:7.451, tidally_locked:true , v_r:5.4 },
];
...
// ── DEEP SPACE EM WAVE CANVAS ────────────────────────────────────────────────
// Physically accurate: dipole EMF burst at emission, transverse EM wave propagation,
// expanding wavefront ring at Earth reception.
function useDeepSpaceCanvas(canvasRef, prog, target) {
  ...
  useEffect(() => {
    ...
    // Generate parallax star layers once
    if (!starsRef.current) {
      starsRef.current = [
        Array.from({length:180}, () => ({ x:Math.random(), y:Math.random(), r:Math.random()*0.7+0.2, a:Math.random()*0.45+0.1, sp:Math.random()*0.018+0.004, ph:Math.random()*Math.PI*2, par:0.015, hex:null })),
        Array.from({length:70},  () => ({ x:Math.random(), y:Math.random(), r:Math.random()*1.1+0.4, a:Math.random()*0.55+0.2, sp:Math.random()*0.028+0.008, ph:Math.random()*Math.PI*2, par:0.05,  hex:Math.random()>0.8?(Math.random()>0.5?"#ffd8a8":"#a8c8ff"):null })),
        Array.from({length:25},  () => ({ x:Math.random(), y:Math.random(), r:Math.random()*1.8+0.7, a:Math.random()*0.65+0.3, sp:Math.random()*0.038+0.015, ph:Math.random()*Math.PI*2, par:0.12,  hex:Math.random()>0.7?(Math.random()>0.5?"#ffe4b5":"#b8d4ff"):null }))
      ];
    }
    ...
    const draw = (ts) => {
      ...
      bgG.addColorStop(0,"#000306"); bgG.addColorStop(0.5,"#00080f"); bgG.addColorStop(1,"#000306");
      ...
      neb(W*0.18+Math.sin(t*0.04)*4, H*0.42, W*0.24, "rgba(16,0,64,0.22)");
      neb(W*0.80+Math.sin(t*0.035)*4, H*0.58, W*0.22, "rgba(0,24,72,0.20)");
      neb(W*0.50, H*0.50, W*0.40, "rgba(0,8,32,0.14)");
      ...
      starsRef.current.forEach(layer => layer.forEach(s => {
        ...
        const sy = s.y * H;
        if (s.hex) { const h=s.hex.slice(1); ctx.fillStyle=`rgba(${parseInt(h.slice(0,2),16)},${parseInt(h.slice(2,4),16)},${parseInt(h.slice(4,6),16)},${alpha})`; }
        else { ctx.fillStyle=`rgba(200,220,255,${alpha})`; }
        ctx.beginPath(); ctx.arc(sx,sy,s.r,0,Math.PI*2); ctx.fill();
        if (s.par>0.08 && s.r>1.4 && alpha>0.5) {
          ctx.strokeStyle=`rgba(200,220,255,${alpha*0.28})`; ctx.lineWidth=0.5;
      ...
      // ── LAYOUT ──────────────────────────────────────────────────────────────
      const PX=115, EX=W-105, MY=H/2, span=EX-PX;

      // Galaxy label
      ctx.font="bold 10px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,180,255,0.20)"; ctx.textAlign="center";
      ctx.fillText("✦  MILKY WAY GALAXY  ✦", W/2, 15);

      // Distance label
      ctx.font="11px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,180,255,0.30)"; ctx.textAlign="center";
      ctx.fillText("← " + fmtDelay(distanceLY) + " →", W/2, MY-22);

      // ── SOURCE STAR (host) ───────────────────────────────────────────────────
      const sX=PX-52, sY=MY-30, sPulse=1+0.06*Math.sin(t*1.8);
      for(let g=4;g>=1;g--) { const gr=ctx.createRadialGradient(sX,sY,0,sX,sY,25*g); gr.addColorStop(0,"rgba(255,240,160,0.07)"); gr.addColorStop(1,"rgba(0,0,0,0)"); ctx.fillStyle=gr; ctx.beginPath(); ctx.arc(sX,sY,25*g,0,Math.PI*2); ctx.fill(); }
      ...
      // ── SOURCE PLANET ────────────────────────────────────────────────────────
      const pPulse=1+0.03*Math.sin(t*1.1);
      for(let g=3;g>=1;g--) { const hg=ctx.createRadialGradient(PX,MY,22,PX,MY,36*g); hg.addColorStop(0,col+"25"); hg.addColorStop(1,"rgba(0,0,0,0)"); ctx.fillStyle=hg; ctx.beginPath(); ctx.arc(PX,MY,36*g,0,Math.PI*2); ctx.fill(); }
      const pGrd=ctx.createRadialGradient(PX-7,MY-7,2,PX,MY,27*pPulse); pGrd.addColorStop(0,"rgba(255,255,255,0.32)"); pGrd.addColorStop(0.3,col); pGrd.addColorStop(0.7,col+"aa"); pGrd.addColorStop(1,"rgba(0,0,0,0.82)"); ctx.fillStyle=pGrd; ctx.beginPath(); ctx.arc(PX,MY,27*pPulse,0,Math.PI*2); ctx.fill();
      ctx.save(); ctx.beginPath(); ctx.arc(PX,MY,27,0,Math.PI*2); ctx.clip(); ctx.strokeStyle="rgba(0,0,0,0.16)"; ctx.lineWidth=3.5; [-7,4,13].forEach(dy=>{ctx.beginPath();ctx.ellipse(PX,MY+dy,27,6,0,0,Math.PI*2);ctx.stroke();}); ctx.restore();
      if(target.type&&(target.type.includes("Jupiter")||target.type.includes("Gas"))) { ctx.beginPath(); ctx.ellipse(PX,MY+5,44,10,0,0,Math.PI*2); ctx.strokeStyle=col+"40"; ctx.lineWidth=2.5; ctx.stroke(); }
      ctx.beginPath(); ctx.arc(PX,MY,31,0,Math.PI*2); ctx.strokeStyle=col+"30"; ctx.lineWidth=3.5; ctx.stroke();
      ctx.font="bold 12px 'IBM Plex Mono',monospace"; ctx.fillStyle=col; ctx.textAlign="center"; ctx.fillText(target.planet,PX,MY+48);
      ctx.font="9px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,200,255,0.42)"; ctx.fillText(target.system,PX,MY+60);

      // ═══════════════════════════════════════════════════════════════════════
      // ── PHASE 1: EMF DIPOLE BURST AT EMISSION (p < 0.08) ─────────────────
      // ═══════════════════════════════════════════════════════════════════════
      if (p < 0.08) {
        const ef = 1 - p/0.08; // 1→0 fade
        const burstScale = 1 + (p/0.08)*3.5;

        // Dipole field lines radiating from planet in all directions
        // E-field lines: radiate outward in dipole pattern (stronger along equator, zero at poles)
        for (let angle=0; angle<360; angle+=15) {
          const rad = angle * Math.PI/180;
          // Dipole strength: sin²(θ) — maximum on equator (θ=90°), zero at poles
          const theta = Math.abs((angle % 180) - 90) * Math.PI/180; // angle from pole
          const dipoleStrength = Math.sin(theta); // 0 at poles, 1 at equator
          if (dipoleStrength < 0.1) continue;

          const lineLen = (18 + dipoleStrength * 55) * burstScale;
          const alpha = ef * dipoleStrength * 0.75;

          // Field line curves outward
          const ex2 = PX + Math.cos(rad)*lineLen;
          const ey2 = MY + Math.sin(rad)*lineLen;

          // Color: E-field in cyan, B-field perpendicular in magenta
          const isEField = (Math.floor(angle/15) % 2 === 0);
          ctx.strokeStyle = isEField
            ? `rgba(0,230,255,${alpha})`
            : `rgba(200,100,255,${alpha})`;
          ctx.lineWidth = 0.8 + dipoleStrength * 0.8;
          ctx.beginPath();
          // Curved field line using quadratic bezier
          const cpx = PX + Math.cos(rad) * lineLen * 0.5 + Math.sin(rad)*12*burstScale;
          const cpy = MY + Math.sin(rad) * lineLen * 0.5 - Math.cos(rad)*12*burstScale;
          ctx.moveTo(PX + Math.cos(rad)*10, MY + Math.sin(rad)*10);
          ctx.quadraticCurveTo(cpx, cpy, ex2, ey2);
          ctx.stroke();

          // Arrowhead at tip
          if (dipoleStrength > 0.5) {
            const arrowAngle = Math.atan2(ey2-cpy, ex2-cpx);
            ctx.beginPath();
            ctx.moveTo(ex2, ey2);
            ctx.lineTo(ex2 - 5*Math.cos(arrowAngle-0.4), ey2 - 5*Math.sin(arrowAngle-0.4));
            ctx.lineTo(ex2 - 5*Math.cos(arrowAngle+0.4), ey2 - 5*Math.sin(arrowAngle+0.4));
            ctx.closePath();
            ctx.fillStyle = isEField ? `rgba(0,230,255,${alpha*0.8})` : `rgba(200,100,255,${alpha*0.8})`;
            ctx.fill();
          }
        }

        // Expanding spherical wavefront rings from burst
        for (let ring=0; ring<3; ring++) {
          const ringR = (p/0.08) * (60 + ring*25) * burstScale;
          const ringAlpha = ef * (0.6 - ring*0.15);
          if (ringR > 0) {
            ctx.beginPath(); ctx.arc(PX, MY, ringR, 0, Math.PI*2);
            ctx.strokeStyle = `rgba(0,220,255,${ringAlpha})`; ctx.lineWidth = 1.5 - ring*0.4; ctx.stroke();
          }
        }

        // Legend
        ctx.font="9px 'IBM Plex Mono',monospace"; ctx.textAlign="left";
        ctx.fillStyle="rgba(0,230,255,0.6)"; ctx.fillText("E⃗ field",PX+38,MY-18);
        ctx.fillStyle="rgba(200,100,255,0.6)"; ctx.fillText("B⃗ field",PX+38,MY-7);
      }

      // ═══════════════════════════════════════════════════════════════════════
      // ── PHASE 2: TRANSVERSE EM WAVE PROPAGATING THROUGH SPACE (p > 0.04) ─
      // ═══════════════════════════════════════════════════════════════════════
      if (p > 0.04 && p < 0.99) {
        const sigX = PX + span * p;
        const waveLen = 48;   // spatial wavelength in pixels
        const amplitude = 16; // max displacement in pixels
        const waveSpeed = t * 4.0; // phase velocity

        // How much of the path is behind the photon
        const pathLen = span * p;
        const waveStart = Math.max(PX, sigX - Math.min(pathLen, 320));

        // Fade-in near planet, fade-out near photon tip
        ctx.save();

        // Draw E-field wave (vertical oscillation — electric field)
        ctx.beginPath();
        let first = true;
        for (let wx = waveStart; wx <= sigX; wx += 2) {
          const distFromTip = sigX - wx;
          const distFromStart = wx - waveStart;
          const fadeIn  = Math.min(distFromStart / 40, 1);
          const fadeOut = Math.min(distFromTip / 30, 1);
          const fade = fadeIn * fadeOut;
          const phase = (wx / waveLen) * Math.PI * 2 - waveSpeed;
          const ey = MY + Math.sin(phase) * amplitude * fade;
          if (first) { ctx.moveTo(wx, ey); first=false; }
          else { ctx.lineTo(wx, ey); }
        }
        ctx.strokeStyle = "rgba(0,230,255,0.75)";
        ctx.lineWidth = 1.8;
        ctx.stroke();

        // E-field label near midpoint
        const midX = waveStart + (sigX-waveStart)*0.5;
        ctx.font="9px 'IBM Plex Mono',monospace"; ctx.textAlign="center";
        ctx.fillStyle="rgba(0,230,255,0.55)"; ctx.fillText("E⃗",midX, MY - amplitude - 6);

        // Draw B-field wave (out-of-plane shown as depth dots — perpendicular to both E and k)
        // Visualized as a dashed line slightly offset with dot markers
        for (let wx = waveStart; wx <= sigX; wx += 6) {
          ...
          const fade = fadeIn * fadeOut;
          const phase = (wx/waveLen)*Math.PI*2 - waveSpeed;
          const bStrength = Math.cos(phase) * fade; // B is 90° out of phase with E in space

          // Dot size represents B-field magnitude (into/out of screen)
          const dotR = Math.abs(bStrength) * 3.5;
          if (dotR > 0.3) {
            ctx.beginPath(); ctx.arc(wx, MY, dotR, 0, Math.PI*2);
            const bAlpha = Math.abs(bStrength) * 0.7;
            ctx.fillStyle = bStrength > 0
              ? `rgba(200,100,255,${bAlpha})`   // dot = coming out of screen
              : `rgba(200,100,255,${bAlpha*0.6})`; // x = going into screen
            ctx.fill();
            // Cross for into-screen
            if (bStrength < -0.3) {
              ctx.strokeStyle=`rgba(200,100,255,${bAlpha*0.8})`; ctx.lineWidth=0.8;
        ...
        ctx.font="9px 'IBM Plex Mono',monospace"; ctx.textAlign="center";
        ctx.fillStyle="rgba(200,100,255,0.55)"; ctx.fillText("B⃗",midX, MY + amplitude + 14);

        // Direction of propagation arrow (k vector)
        ctx.strokeStyle="rgba(255,255,255,0.18)"; ctx.lineWidth=0.8; ctx.setLineDash([3,5]);
        ctx.beginPath(); ctx.moveTo(waveStart,MY); ctx.lineTo(sigX-16,MY); ctx.stroke(); ctx.setLineDash([]);

        ctx.restore();

        // ── PHOTON HEAD ───────────────────────────────────────────────────────
        // Glowing photon wavefront at the leading edge
        const phG = ctx.createRadialGradient(sigX,MY,0,sigX,MY,16);
        phG.addColorStop(0,"rgba(255,255,255,1)");
        phG.addColorStop(0.25,"rgba(120,245,255,0.95)");
        phG.addColorStop(0.6,"rgba(0,200,255,0.4)");
        phG.addColorStop(1,"rgba(0,150,255,0)");
        ctx.fillStyle=phG; ctx.beginPath(); ctx.arc(sigX,MY,16,0,Math.PI*2); ctx.fill();

        // Pulsing wavefront rings ahead of photon
        const pulseP = (t*2.8) % 1;
        [0, 0.35, 0.7].forEach(off => {
          const pf = (pulseP+off) % 1;
          const pr = pf * 24;
          const pa = (1-pf) * 0.55;
          ctx.beginPath(); ctx.arc(sigX, MY, pr, 0, Math.PI*2);
          ctx.strokeStyle=`rgba(0,232,255,${pa})`; ctx.lineWidth=1.4; ctx.stroke();
        });

        // Lens flare
        const fA = 0.3 + 0.12*Math.sin(t*5);
        [-1,1].forEach(dir => {
          const fG=ctx.createLinearGradient(sigX,MY,sigX+dir*45,MY);
          fG.addColorStop(0,`rgba(180,240,255,${fA})`); fG.addColorStop(1,"rgba(0,200,255,0)");
        ...
        if (p > 0.06 && p < 0.96) {
          ...
          ctx.font="11px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,240,255,0.7)"; ctx.textAlign="center";
          ctx.fillText((tLY<1?fmtDelay(tLY):tLY.toFixed(2)+" ly")+" traveled", sigX, MY - amplitude - 22);
        }
        ...
        [0.25,0.5,0.75].forEach(frac => {
          ...
          ctx.strokeStyle="rgba(0,180,255,0.14)"; ctx.lineWidth=1;
          ctx.beginPath(); ctx.moveTo(mx,MY+4); ctx.lineTo(mx,MY+11); ctx.stroke();
          const mLY=distanceLY*frac;
          ctx.font="8px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,180,255,0.22)"; ctx.textAlign="center";
      ...
      // ── EARTH ────────────────────────────────────────────────────────────────
      // Magnetosphere
      const magG=ctx.createRadialGradient(EX,MY,22,EX,MY,115);
      magG.addColorStop(0,"rgba(0,70,200,0.14)"); magG.addColorStop(0.5,"rgba(0,40,140,0.05)"); magG.addColorStop(1,"rgba(0,0,0,0)");
      ctx.fillStyle=magG; ctx.beginPath(); ctx.arc(EX,MY,115,0,Math.PI*2); ctx.fill();

      // Magnetosphere field lines (always visible)
      for (let mLine=0; mLine<8; mLine++) {
        const mAngle = (mLine/8)*Math.PI*2;
        const mR1=42, mR2=85;
        ctx.beginPath();
        ctx.moveTo(EX+Math.cos(mAngle)*mR1, MY+Math.sin(mAngle)*mR1);
        ctx.quadraticCurveTo(
          EX+Math.cos(mAngle)*(mR1+mR2)*0.7 + Math.sin(mAngle)*20,
          MY+Math.sin(mAngle)*(mR1+mR2)*0.7 - Math.cos(mAngle)*20,
          EX+Math.cos(mAngle)*mR2, MY+Math.sin(mAngle)*mR2
        );
        ctx.strokeStyle="rgba(0,100,255,0.09)"; ctx.lineWidth=0.8; ctx.stroke();
      }
      ...
      ctx.restore();
      const atmA=0.16+0.05*Math.sin(t*0.75);
      const atmG=ctx.createRadialGradient(EX,MY,24,EX,MY,40); atmG.addColorStop(0,"rgba(100,180,255,0)"); atmG.addColorStop(0.7,`rgba(100,180,255,${atmA})`); atmG.addColorStop(1,"rgba(60,120,255,0)");
      ctx.fillStyle=atmG; ctx.beginPath(); ctx.arc(EX,MY,40,0,Math.PI*2); ctx.fill();
      ...
      ctx.font="bold 12px 'IBM Plex Mono',monospace"; ctx.fillStyle="#4fc3f7"; ctx.textAlign="center"; ctx.fillText("EARTH",EX,MY+48);
      ctx.font="9px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,200,255,0.42)"; ctx.fillText("Observer",EX,MY+60);

      // ═══════════════════════════════════════════════════════════════════════
      // ── PHASE 3: ARRIVAL — EM WAVEFRONT HITS EARTH'S MAGNETOSPHERE ────────
      // ═══════════════════════════════════════════════════════════════════════
      if (p > 0.93) {
        const fl = (p - 0.93) / 0.07; // 0→1

        // Expanding reception rings from magnetosphere impact
        for (let ring=0; ring<4; ring++) {
          const delay = ring * 0.22;
          const rfl = Math.max(0, fl - delay);
          if (rfl <= 0) continue;
          const ringR = 28 + rfl * (55 + ring*18);
          const ringA = (1 - rfl) * (0.7 - ring*0.12);
          ctx.beginPath(); ctx.arc(EX,MY,ringR,0,Math.PI*2);
          ctx.strokeStyle=`rgba(0,255,180,${ringA})`; ctx.lineWidth=2-ring*0.4; ctx.stroke();
        }

        // Magnetosphere lighting up — field lines glow
        if (fl > 0.3) {
          for (let mLine=0; mLine<8; mLine++) {
            const mAngle=(mLine/8)*Math.PI*2;
            const mR1=42, mR2=85;
            ctx.beginPath();
            ctx.moveTo(EX+Math.cos(mAngle)*mR1, MY+Math.sin(mAngle)*mR1);
            ctx.quadraticCurveTo(EX+Math.cos(mAngle)*(mR1+mR2)*0.7+Math.sin(mAngle)*20, MY+Math.sin(mAngle)*(mR1+mR2)*0.7-Math.cos(mAngle)*20, EX+Math.cos(mAngle)*mR2, MY+Math.sin(mAngle)*mR2);
            ctx.strokeStyle=`rgba(0,255,180,${(fl-0.3)*0.25})`; ctx.lineWidth=1.2; ctx.stroke();
          }
        }

        // Reception glow
        const recG=ctx.createRadialGradient(EX,MY,0,EX,MY,120*fl);
        recG.addColorStop(0,`rgba(0,255,180,${fl*0.22})`); recG.addColorStop(1,"rgba(0,0,0,0)");
        ctx.fillStyle=recG; ctx.beginPath(); ctx.arc(EX,MY,120*fl,0,Math.PI*2); ctx.fill();
      }

      // ── ARRIVAL LABEL ────────────────────────────────────────────────────────
      if (p >= 1) {
        ctx.font="bold 13px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,245,110,0.95)"; ctx.textAlign="center";
        ctx.fillText("✓  EM WAVEFRONT RECEIVED — SIGNAL LOCKED", EX, MY-50);
        ctx.font="10px 'IBM Plex Mono',monospace"; ctx.fillStyle="rgba(0,200,255,0.65)";
        ctx.fillText("Delay: "+fmtDelay(distanceLY), EX, MY-36);
      }
...
function DeepSpaceCanvas({ prog, target }) {
  ...
  return <canvas ref={canvasRef} width={900} height={260} style={{width:"100%",height:260,display:"block"}}/>;
}
